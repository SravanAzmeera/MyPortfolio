...
function myMenuFunction(){
  ...
  function redirectToLinkedIn(){
    window.location.href = "https://www.linkedin.com/in/sravan-azmeera-2b3a9425b/"
  }
  
  function redirectToGithub(){
    window.location.href = "https://github.com/SravanAzmeera"
  }
  ...
  function sendEmail() {
    ...
    emailjs.send("service_rqay4ug", "template_3tykpds", {
        from_name: name,
        reply_to: email,
        message: message
    })
